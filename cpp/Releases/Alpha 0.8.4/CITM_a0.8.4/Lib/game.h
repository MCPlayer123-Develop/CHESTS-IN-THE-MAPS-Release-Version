...
extern int vis[N][N], advancements[105], flag, portal_status, debug_screen, nether_return;
extern int item_prize[30];
extern string world_name;
extern string l[10005];
...
extern string title_slogan[30];
extern string biome[10];
extern int skin_color;
extern char skin_char;
extern map<string, string> lang;
extern int language;
extern string language_name[1005];
extern string language_file_name[1005];
extern int language_code_page[1005];

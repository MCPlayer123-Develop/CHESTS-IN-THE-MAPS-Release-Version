...
string language_file_name[1005] = {
    "en-US.txt", "zh-CN.txt", "zh-TW.txt", "fr.txt", "ru.txt", "ar.txt", "pr.txt", "ja.txt"
};
int language_code_page[1005] = {
    1252, 936, 950, 1252, 1251, 1256, 1252, 1252, 932
};

...
void chest() {
    ...
    for (int i = 0; i < 8; i++) {
        ...
        printf(lang["chest.border_mid"].c_str());
    }
...
void chest_nether() {
    ...
    for (int i = 15; i < 17; i++) {
        ...
        if (i < 16) printf(lang["chest.border_mid"].c_str());
    }
...
void view_inventory() {
    ...
    for (int i = 0; i < 21; i++) {
        ...
        if (i < 19) {
            printf(lang["view_inventory.border_mid"].c_str());
        }
    }
...
void eatFood() {
    ...
    printf(lang["eatFood.border_mid"].c_str());
